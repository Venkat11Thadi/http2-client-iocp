...
//    if (!ssl_ctx) {
//        printf("Could not create SSL/TLS context: %s",
...
//
//    if (rv != 0) {
//        printf("Could not connect to the remote host %s", host);
//    }
